...
%                       If writing to a new file, the correct extension is ".nev"
%                  2. The filename must be a string and a row vector.
%                  Example:  
%                      Filename = 'C:\TestDirectory\TestFile.nev'
%
...
%                  and EventStrings fields only, then we would have two parameters.  The order must also follow along with the
...
% 
%         Function( Filename, AppendFile, ExtractMode, 1, NumRecs, FieldSelection, Timestamps, EventStrings );
%         
...
%         ModeArray(3) = 9;
% 
%         Function( Filename, AppendFile, ExtractMode, ModeArray, NumRecs, FieldSelection, Timestamps, EventIDs, Ttls, Extras, EventStrings, Header );
%         
