...
%                  Example:  
%                      Filename = 'C:\TestDirector\TestFile.ncs'
%                  
...
% Output Parameters
%
%   The 6 variables Nlx2MatCSC outputs are as follows:
%   TimeStamps, ChannelNumbers, SampleFrequencies, NumberValidSamples, Samples and NlxHeader in that order.
%   TimeStamps, ChannelNumbers, SampleFrequencies and NumberValidSamples are one dimensional matrices,
%   while Samples is a 2 Dimensional matrix.
...
%         ModeArray(3) = 9;
% 
%         [Timestamp, ChanNum, SampleFrequency, NumValSamples, Samples] = Nlx2MatCSC( Filename, FieldSelection, ExtractHeader, ExtractMode, ModeArray );
%         
%
% Matlab Tips
%
