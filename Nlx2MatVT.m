...
%                  Example:  
%                      Filename = 'C:\TestDirector\TestFile.nvt'
%                  
...
% Output Parameters
%
% The 6 variables Nlx2MatVT outputs are:
% TimeStamps, ExtractedX, ExtractedY, ExtractedAngle, Targets, Points and NlxHeader in that order.
% TimeStamps, ExtractedX, ExtractedY and ExtractedAngle, are one dimensional matrices,
% Targets, and Points are 2 dimensional matrices
% NlxHeader is a one dimensional cell array used for viewing purposes only.
...
% 
%         [TimestampVariable, TargetsVariable, HeaderVariable] = Function( Filename, FieldSelection, ExtractHeader, ExtractMode );
%         
...
%         ModeArray(3) = 9;
% 
%         [TimeStamps, ExtractedX, ExtractedY, ExtractedAngle, Targets, Points] = Nlx2MatVT( Filename, FieldSelection, ExtractHeader, ExtractMode, ModeArray );
%         
%
% Matlab Tips
%
