...
%                  Requirements
%                  1. The file must be a Neuralynx Event data file.
%                  2. The filename must be a string and a row vector.
%                  Example:  
%                      Filename = 'C:\TestDirector\TestFile.nev'
%                  
...
%                  Example:   We want to extract fields for Timestamps and Event Strings Only.
%                      FieldSelection(1) = 1;
%                      FieldSelection(2) = 0;
%                      FieldSelection(3) = 0;
%                      FieldSelection(4) = 0;
...
% Output Parameters
%
% The 6 variables Nlx2MatEV outputs are as follows:
% TimeStamps, EventIDs, Nttls, Extras, EventStrings and NlxHeader in that order.
% TimeStamps, EventIDs and Nttls are one dimensional matrices,
% Extras and EventStrings are 2 dimensional matrices.
% NlxHeader is a one dimensional cell array.
...
%         
%         Example: If we continue with the example from Parameter2 and we know that we want the Timestamp and Event Strings fields extracted, the output will be as follows:
% 
%         [TimestampVariable, EventStrings, HeaderVariable] = Function( Filename, FieldSelection, ExtractHeader, ExtractMode );
%         
...
%         ModeArray(3) = 9;
% 
%         [TimeStamps, EventIDs, Nttls, Extras, EventStrings] = Nlx2MatEV( Filename, FieldSelection, ExtractHeader, ExtractMode, ModeArray );
%        
% Matlab Tips
%
